package net.ivanzavala.cargaimagenes.data;
...
import net.ivanzavala.cargaimagenes.MainActivity;
import net.ivanzavala.cargaimagenes.R;
import net.ivanzavala.cargaimagenes.model.ImagenC;
import net.ivanzavala.cargaimagenes.view.Fragmaneto;
